...
function insert($conn){
    ...
    if ($_POST['id'] > 0) { //updatinimas
        update($conn);
    } 
    
    else if ($_POST['id'] === '') {//nauju duomenu ikelimas
        insert($conn);
    }
    ...
    if (isset($_GET['automobiliai'])) {
        ...
        $result = $conn->query($sql);
        require_once 'views/automobiliai.php';
    }
